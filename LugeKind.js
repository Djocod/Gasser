...
function createChassis(offsetX, offsetY, offsetZ, offRotX, offRoty, offRotZ) {
  ...
  const weaveTexture = textureLoader.load(color4.value);
...
// ============ chassis patin============
function createTubeChassisLeft(offsetX, offsetY, offsetZ, offRoty, offRotZ) {
  const textureLoader = new THREE.TextureLoader();
  const weaveTexture = textureLoader.load("./img/bois-1.jpg");
  weaveTexture.wrapS = THREE.RepeatWrapping;
  weaveTexture.wrapT = THREE.RepeatWrapping;
...
// ==============================
export function createLugeKind() {
  ...
  tubeGroupLeft.add(createTubeChassisLeft(-0.65, 0.15, -0.26, -0.1, -0.4));
  tubeGroupLeft.add(createTubeChassisLeft(-0.1, 0.16, -0.26, 0, 0.2));

  const tubeGroupRight = new THREE.Group();
  tubeGroupRight.name = "tubeRight";
  tubeGroupRight.add(createTubeChassisRight(-0.65, 0.15, 0.26, 0.1, -0.4));
  tubeGroupRight.add(createTubeChassisRight(-0.1, 0.16, 0.26, 0, 0.2));
  ...
  capGroupBtm.add(createCapBottom(-0.78, 0.08, 0.26, 0, 0, 0));
  capGroupBtm.add(createCapBottom(-0.78, 0.08, -0.26, 0, 0, 0));
  ...
  capGroupBtm.add(createCapBottomHoop(-0.74, 0.235, 0.23, 0, 0, 0));
  capGroupBtm.add(createCapBottomHoop(-0.74, 0.235, -0.23, 0, 0, 0));
